<template>
  <q-page class="flex column" padding>
    ...
    <p class="text-body1">
      ...
      cum dolorem perspiciatis laudantium, excepturi odit voluptates praesentium
      laboriosam magnam, deleniti ipsa quidem ducimus voluptatum modi omnis
      tempore optio beatae!
    </p>
    <p class="text-body2">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime atque
      numquam temporibus veritatis sit aliquid cupiditate doloribus, sint nisi
      rerum aspernatur ex minus quisquam soluta laboriosam fugiat consequatur,
